...
class UAV123(object):
    ...
    def __init__(self, root_dir, version='UAV123'):
        ...
        self.anno_files = glob.glob('/home/lsw/PycharmProjects/UAVdatasets/UAV123@10FPS/anno/UAV123_10fps/*.txt')    #UAV123_10fps将下面两行注释使用这一行
        # self.anno_files = sorted(glob.glob(                     #使用UAV123和UAV20L
        #     os.path.join(root_dir, 'anno/%s/*.txt' % version)))#使用UAV123和UAV20L
